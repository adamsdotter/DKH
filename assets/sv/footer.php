            <footer class="footer">
                <div class="container--full footer-wrapper">
                    <ul class="vcard site-footer">
                        ...
                        <li class="site-footer-item"><a class="icon-fb" target="_blank" href="https://www.facebook.com/doktorkomhem" title="Doktor Kom Hem på Facebook"><span>Facebook</span></a>
                        </li>
                    </ul>
                </div>
            </footer>
